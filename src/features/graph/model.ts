...
export const DEMO_GRAPH: InfluenceGraph = {
  ...
  edges: [
    ...
    },
    {
      ...
      target: 'goal-launch',
      type: 'boosts',
      label: 'Пропускная способность действий',
      weight: 0.69,
      confidence: 0.79,
    },
    {
    ...
    },
    {
      ...
      target: 'domain-stress',
      type: 'drags',
      label: 'Давление неопределённости',
      weight: 0.39,
      confidence: 0.66,
    },
    {
